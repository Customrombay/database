...
**<span style="color:lime">[✓]</span>** EvolutionX - using the mainstream [devices.json file](https://github.com/Evolution-X-Devices/official_devices/blob/master/devices.json), 66/66 devices supported \
...
**<span style="color:yellow">[/]</span>** xiaomi.eu - using the [official MIUI 14 STABLE RELEASE thread](https://xiaomi.eu/community/threads/miui-14-stable-release.67685/), no support for automation, 21/62 devices supported \
...
**<span style="color:yellow">[/]</span>** TWRP - using the [twrpme repository](https://github.com/TeamWin/twrpme), 294/826 devices supported
